...
if __name__ == "__main__":
    ...
    # input_dic, output_dic = config.prepare_input_output_dic(config.tamil_alphabets, config.english_alphabets)
    ...
    # input_dic, output_dic = config.prepare_input_output_dic(config.tamil_alphabets, config.english_alphabets)
    # print(lstm.predict('கரம்', 'TaEn', input_dic, output_dic))
    ...
    input_dic, output_dic = config.prepare_input_output_dic(config.hindi_alphabets, config.english_alphabets)
    # print(lstm.predict('Hello', 'HiEn', input_dic, output_dic))
    ...
    input_dic, output_dic = config.prepare_input_output_dic(config.tamil_alphabets, config.english_alphabets)
    # print(lstm.predict('Hello', 'TaEn', input_dic, output_dic))
